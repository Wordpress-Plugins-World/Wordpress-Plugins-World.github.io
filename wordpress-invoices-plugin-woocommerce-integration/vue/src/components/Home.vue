    ...
    <header class="site-header">
        <div class="container">
            ...
            <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              <title>WP Invoices - PDF Electronic Invoicing System</title>
                <defs>
        ...
        <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">WP Invoices - PDF Electronic Invoicing System</h1>
	                        <p class="hero-paragraph"> “WP Invoices” is electronic invoicing and warehouse management plugin for <b>WordPress</b> which allows you to issue, send and download invoices as pdf file. Very easy to use interface with included many features to make your work pleasant.</p>
	                        <div class="hero-cta">
                                 <router-link class="button button-shadow" to="/demo">
                                    DEMO
                                </router-link>
                                <a class="button button-primary button-shadow" href="https://codecanyon.net/item/wp-invoices-pdf-electronic-invoicing-system/36891583">Purchase</a>
                            </div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" :src="'./imgs/wp-invoices-woocommerce-integration.png'" alt="App preview">
                        ...
                        <div class="features-wrap">
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">WooCommerce</h3>
                                    <p class="text-sm mb-0">With the WooCommerce integration can automatically issue and send invoices on each order.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">PDF</h3>
                                    <p class="text-sm mb-0">Download or send invoices as PDF file.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Warehouse</h3>
                                    <p class="text-sm mb-0">Add products quantities and track availabality</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Multiple Templates</h3>
                                    <p class="text-sm mb-0">There are several templates which can choose for your invoices with one click.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">CSV Export</h3>
                                    <p class="text-sm mb-0">Export all invoices in csv format.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Fully Translatable</h3>
                                    <p class="text-sm mb-0">Fully translatable invoices.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-sm">
                    <div class="media-inner section-inner">
                        <div class="media-header text-center">
                            <h2 class="section-title mt-0">Automatic amounts calculation</h2>
                            <p class="section-paragraph mb-0">For each item amount, changed tax or vat the plugin will automatically calculate amounts of the invoice with custom decimal digits. Ofcourse you can disable this functionality any time.</p>
                        </div>
						<div class="media-canvas">
							<img style="border: 5px solid;" :src="'./imgs/create-invoice-screen.png'" >
						</div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0">Buy now</h2>
                            <p class="section-paragraph">Purchase with support included.</p>
                        </div>
                        <div class="footer-form newsletter-form field field-grouped">
							...
							align-items: center;
							width: 100%;">
                                <a class="button button-primary button-block button-shadow" href="https://codecanyon.net/item/wp-invoices-pdf-electronic-invoicing-system/36891583">BUY NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
