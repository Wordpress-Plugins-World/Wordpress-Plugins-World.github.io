...
<template>
  <div class="body-wrap boxed-container">
    ...
    <main>
        ...
        <div class="hero-copy">
                      <h1 class="hero-title mt-0">Login Defender</h1>
                      <p class="hero-paragraph">Login Defender adds the best in WordPress plugin security logins to your website with just a few clicks.<br>

                        Stop unauthorized logins by setting up a multiple type of permissions.<br>

                        Defender starts with a list of one-click hardening techniques that will instantly add layers of protection to your site.</p>
                      <div class="hero-cta">
                        <router-link class="button button-shadow" to="/demo">
                            DEMO
                        </router-link>
                        <a class="button button-primary button-shadow" href="https://codecanyon.net/item/login-defender/36504462">Purchase</a>
                      </div>
        </div>
        <div class="hero-app">
          ...
          <img class="device-mockup" :src="'./imgs/590x300.png'" alt="App preview">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M10 10v22c0 12.15 9.85 22 22 22h22V32c0-12.15-9.85-22-22-22H10z" fill="url(#feature-3-c)" transform="rotate(45 32 32)"/>
                                ...
                                <h3 class="feature-title mt-24">Restriction by Country</h3>
                                <p class="text-sm mb-0">Set login restriction by Country. Can add list of allowed or disallowed countries.</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M40 64H16V40c0-13.255 10.745-24 24-24h24v24c0 13.255-10.745 24-24 24" fill="url(#feature-1-b)"/>
                                ...
                                <h3 class="feature-title mt-24">IP Address Restriction</h3>
                                <p class="text-sm mb-0">Set restriction by ip address/es</p>
                            </div>
                        </div>
          <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="68" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M16 0v24c0 13.255 10.745 24 24 24h24V24C64 10.745 53.255 0 40 0H16z" fill="url(#feature-2-b)"/>
                                ...
                                <h3 class="feature-title mt-24">Proxy Detection</h3>
                                <p class="text-sm mb-0">Detect if user use proxy.</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M40 48H16V24C16 10.745 26.745 0 40 0h24v24c0 13.255-10.745 24-24 24" fill="url(#feature-4-b)"/>
                                ...
                                <h3 class="feature-title mt-24">Mobile Device Detection</h3>
                                <p class="text-sm mb-0">Save to login history if user is using mobile device.</p>
                            </div>
                        </div>
          <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M10.113 10.113v22c0 12.15 9.85 22 22 22h22v-22c0-12.15-9.85-22-22-22h-22z" fill="url(#feature-5-b)" transform="rotate(45 32.113 32.113)"/>
                                ...
                                <h3 class="feature-title mt-24">Geo Location</h3>
                                <p class="text-sm mb-0">Save to login history exact geo location of the users. The plugin uses free public api for geo location which is used from many other plugins.</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path fill-opacity=".64" fill="url(#feature-6-b)" d="M24 29.229h40V64H0z"/>
                                ...
                                <h3 class="feature-title mt-24">Type Tracking</h3>
                                <p class="text-sm mb-0">Set only specific user roles which wants to have block tracking. Eg. administrators, editors, etc.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-sm">
                <div class="media-inner section-inner">
                    <div class="media-header text-center">
                        <h2 class="section-title mt-0">Notifications</h2>
                        <p class="section-paragraph mb-0">Block logins that do not comply with the rules or receive only email notifications or both.</p>
                    </div>
        <div class="media-canvas">
          <img style="border: 5px solid;" :src="'./imgs/screen-guard-settings.jpg'">
        </div>
                </div>
            </div>
        </section>
  ...
  <section class="newsletter section">
          ...
          align-items: center;
          width: 100%;">
                            <a class="button button-primary button-block button-shadow" href="https://codecanyon.net/item/login-defender/36504462">BUY NOW</a>
                        </div>
                    </div>
                </div>
            </div>
