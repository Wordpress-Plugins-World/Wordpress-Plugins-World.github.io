...
<template>
  <div class="body-wrap boxed-container">
    <header class="site-header">
        <div class="container">
            ...
            <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              <title>Agile Scrum WordPress</title>
                <defs>
    ...
    <main>
        ...
        <div class="hero-app">
          ...
          <img class="device-mockup" :src="'./imgs/WordPress-Agile-Kanban-Board-Plugin.png'" alt="App preview">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M10 10v22c0 12.15 9.85 22 22 22h22V32c0-12.15-9.85-22-22-22H10z" fill="url(#feature-3-c)" transform="rotate(45 32 32)"/>
                                ...
                                <h3 class="feature-title mt-24">Kanban and List board</h3>
                                <p class="text-sm mb-0">A kanban board is an agile project management tool designed to help visualize work, limit work-in-progress, and maximize efficiency (or flow). It can help both agile and DevOps teams establish order in their daily work.</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M40 64H16V40c0-13.255 10.745-24 24-24h24v24c0 13.255-10.745 24-24 24" fill="url(#feature-1-b)"/>
                                ...
                                <h3 class="feature-title mt-24">Unlimited custom projects with different tasks assigned to them</h3>
                                <p class="text-sm mb-0">Separate your workflow to different projects with different tasks for easy management.</p>
                            </div>
                        </div>
          <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="68" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M16 0v24c0 13.255 10.745 24 24 24h24V24C64 10.745 53.255 0 40 0H16z" fill="url(#feature-2-b)"/>
                                ...
                                <h3 class="feature-title mt-24">Tasks Prioritization</h3>
                                <p class="text-sm mb-0">High, Normal or Low priority of the tasks,</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M40 48H16V24C16 10.745 26.745 0 40 0h24v24c0 13.255-10.745 24-24 24" fill="url(#feature-4-b)"/>
                                ...
                                <h3 class="feature-title mt-24">Notifications</h3>
                                <p class="text-sm mb-0">Custom email notifications for tasks change for each watcher assigned to the task.</p>
                            </div>
                        </div>
          <div class="feature is-revealing">
                            <div class="feature-inner">
                ...
                <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <path d="M10.113 10.113v22c0 12.15 9.85 22 22 22h22v-22c0-12.15-9.85-22-22-22h-22z" fill="url(#feature-5-b)" transform="rotate(45 32.113 32.113)"/>
                                ...
                                <p class="text-sm mb-0">Import/Export tasks from each project.</p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
            ...
            <div class="container-sm">
                <div class="media-inner section-inner">
                    <div class="media-header text-center">
                        <h2 class="section-title mt-0">Responsive Design</h2>
                        <p class="section-paragraph mb-0">Mobile, Tablet and Desktop friendly interface.</p>
                    </div>
        <div class="media-canvas">
          <img style="border: 5px solid;" :src="'./imgs/WordPress-Agile-Scrum-Plugin.png'">
        </div>
                </div>
            </div>
        </section>
  ...
  <section class="newsletter section">
          ...
          align-items: center;
          width: 100%;">
                            <a class="button button-primary button-block button-shadow" href="https://codecanyon.net/item/agile-scrum-project-issue-management/36720961">BUY NOW</a>
                        </div>
                    </div>
                </div>
            </div>
